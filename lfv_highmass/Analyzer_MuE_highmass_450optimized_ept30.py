...
class Analyzer_MuE_highmass_450optimized_ept30(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(Analyzer_MuE_highmass_450optimized_ept30, self).__init__(tree, outfile, **kwargs)
        ...
        self.isGluGluHToTT=('GluGluHToTauTau' in target)
        self.isGluGluHToWW=('GluGluHToWW' in target)
        self.isGluGlu_LFV_HToMuTau_M125=('GluGlu_LFV_HToMuTau_M125' in target)
        self.isGluGlu_LFV_HToMuTau_M130=('GluGlu_LFV_HToMuTau_M130' in target)
        self.isGluGlu_LFV_HToMuTau_M120=('GluGlu_LFV_HToMuTau_M120' in target)
        self.isGluGlu_LFV_HToMuTau_M150=('GluGlu_LFV_HToMuTau_M150' in target)

        self.isGluGlu_LFV_HToMuTau_M200=('GluGlu_LFV_HToMuTau_M200' in target and 'Official' not in target)
        self.isGluGlu_LFV_HToMuTau_M300=('GluGlu_LFV_HToMuTau_M300' in target and 'Official' not in target)
        self.isGluGlu_LFV_HToMuTau_M450=('GluGlu_LFV_HToMuTau_M450' in target and 'Official' not in target)
        self.isGluGlu_LFV_HToMuTau_M600=('GluGlu_LFV_HToMuTau_M600' in target and 'Official' not in target)
        self.isGluGlu_LFV_HToMuTau_M750=('GluGlu_LFV_HToMuTau_M750' in target and 'Official' not in target)
        self.isGluGlu_LFV_HToMuTau_M900=('GluGlu_LFV_HToMuTau_M900' in target and 'Official' not in target)


        self.isOfficial_GluGlu_LFV_HToMuTau_M200=('Official_GluGlu_LFV_HToMuTau_M200' in target)
        self.isOfficial_GluGlu_LFV_HToMuTau_M300=('Official_GluGlu_LFV_HToMuTau_M300' in target)
        self.isOfficial_GluGlu_LFV_HToMuTau_M450=('Official_GluGlu_LFV_HToMuTau_M450' in target)
        self.isOfficial_GluGlu_LFV_HToMuTau_M600=('Official_GluGlu_LFV_HToMuTau_M600' in target)
        self.isOfficial_GluGlu_LFV_HToMuTau_M750=('Official_GluGlu_LFV_HToMuTau_M750' in target)
        self.isOfficial_GluGlu_LFV_HToMuTau_M900=('Official_GluGlu_LFV_HToMuTau_M900' in target)

        self.isGluGluEtauSig=('GluGlu_LFV_HToETau' in target)


        self.isVBFHToTT=('VBFHToTauTau' in target)
        self.isVBFHToWW=('VBFHToWW' in target)
        self.isVBF_LFV_HToMuTau_M120=('VBF_LFV_HToMuTau_M120' in target)
        self.isVBF_LFV_HToMuTau_M125=('VBF_LFV_HToMuTau_M125' in target)
        self.isVBF_LFV_HToMuTau_M130=('VBF_LFV_HToMuTau_M130' in target)
        self.isVBF_LFV_HToMuTau_M150=('VBF_LFV_HToMuTau_M150' in target)
        self.isVBF_LFV_HToMuTau_M200=('VBF_LFV_HToMuTau_M200' in target)
        ...
        self.isttHToTauTau=('ttHJetToTT_M125_13TeV_amcatnloFXFX' in target)
        ...
        self.WZTo2L2Q_weight=2.40974607263e-08 #2.54725706507e-08 #2.66175641194e-08   #2.39150954356e-08 #2.40930214376e-08  #8.91328638844e-07
        self.VVTo2L2Nu_weight=5.53447020181e-08 #5.53447020181e-08  #5.534702e-08
        ...
        self.ZZTo4L_weight=5.92779186525e-08#6.06324080221e-08 #6.10742507181e-08 #5.92779186525e-08 #5.92779186525e-08  #1.3202628761e-06
 ...
 #        self.DYlowmass_weight=1.99619334706e-08
        ...
        self.TT_weight=1.20956576071e-05#1.08602238426e-05#1.07699999667e-05 #1.07699999667e-05  #1.08709111195e-05
        ...
        self.GluGlu_LFV_HToMuTau_M300_weight=7.32222222221e-07            #1.9432e-06 
        self.GluGlu_LFV_HToMuTau_M450_weight=2.70588235294e-07            #1.9432e-06 
        self.GluGlu_LFV_HToMuTau_M600_weight=1.2625e-07    #1.9432e-06 
        self.GluGlu_LFV_HToMuTau_M750_weight=9.93800000005e-08            #1.9432e-06 
        self.GluGlu_LFV_HToMuTau_M900_weight=4.13076923077e-08            #1.9432e-06 


        self.Official_GluGlu_LFV_HToMuTau_M200_weight=1.694e-06            #1.9432e-06 
        self.Official_GluGlu_LFV_HToMuTau_M300_weight=1.33345743863e-07            #1.9432e-06 
        self.Official_GluGlu_LFV_HToMuTau_M450_weight=4.65541809702e-08            #1.9432e-06 
        self.Official_GluGlu_LFV_HToMuTau_M600_weight=2.04664734848e-08    #1.9432e-06 
        self.Official_GluGlu_LFV_HToMuTau_M750_weight=9.93800000005e-09            #1.9432e-06 
        self.Official_GluGlu_LFV_HToMuTau_M900_weight=5.37000000001e-09            #1.9432e-06 
...
#        print electron_Eta," ",muon_Eta
        ...
        if 'LFV' in self.target and 'Official' not in self.target:
...
#        alldirs=['']
    ...
    def fill_histos(self, row,sign,f=None,fillCommonOnly=False,region=None,btagweight=1,sys='',qcdshape=None,pileup='nominal'):
        ...
        if self.is_WJet or self.is_DYJet or self.is_DYlowmass or self.is_ZTauTau:
            ...
            weight=self.WW_weight*self.event_weight(row,region,pileup) 
        elif self.isWZ:
            weight=self.WZ_weight*self.event_weight(row,region,pileup) 
        elif self.isZZ:
            weight=self.ZZ_weight*self.event_weight(row,region,pileup) 
            ...
            weight=self.TTevtgen_weight*self.event_weight(row,region,pileup) 
        
        elif self.isGluGluHToTT:
            weight=self.GluGluHToTT_weight*self.event_weight(row,region,pileup) 
        elif self.isVBFHToTT:
            weight=self.VBFHToTT_weight*self.event_weight(row,region,pileup) 
        elif self.isWminusHToTauTau:
            weight=self.WminusHToTauTau_weight*self.event_weight(row,region,pileup) 
        elif self.isWplusHToTauTau:
            weight=self.WplusHToTauTau_weight*self.event_weight(row,region,pileup) 
        elif self.isZHToTauTau:
            weight=self.ZHToTauTau_weight*self.event_weight(row,region,pileup) 
        elif self.isttHToTauTau:
            weight=self.ttHToTT_weight*self.event_weight(row,region,pileup) 

        elif self.isVBFHToWW:
            weight=self.VBFHToWW_weight*self.event_weight(row,region,pileup) 
        elif self.isGluGluHToWW:
            weight=self.GluGluHToWW_weight*self.event_weight(row,region,pileup) 

        elif self.isGluGlu_LFV_HToMuTau_M120:
            weight=self.GluGlu_LFV_HToMuTau_M120_weight*self.event_weight(row,region,pileup) 
        elif self.isGluGlu_LFV_HToMuTau_M125:
            weight=self.GluGlu_LFV_HToMuTau_M125_weight*self.event_weight(row,region,pileup) 
        elif self.isGluGlu_LFV_HToMuTau_M130:
            weight=self.GluGlu_LFV_HToMuTau_M130_weight*self.event_weight(row,region,pileup) 
        elif self.isGluGlu_LFV_HToMuTau_M150:
            weight=self.GluGlu_LFV_HToMuTau_M150_weight*self.event_weight(row,region,pileup) 
        ...
        elif self.isOfficial_GluGlu_LFV_HToMuTau_M200:
            weight=self.Official_GluGlu_LFV_HToMuTau_M200_weight*self.event_weight(row,region,pileup) 
        elif self.isOfficial_GluGlu_LFV_HToMuTau_M300:
            weight=self.Official_GluGlu_LFV_HToMuTau_M300_weight*self.event_weight(row,region,pileup) 
        elif self.isOfficial_GluGlu_LFV_HToMuTau_M450:
            weight=self.Official_GluGlu_LFV_HToMuTau_M450_weight*self.event_weight(row,region,pileup) 
        elif self.isOfficial_GluGlu_LFV_HToMuTau_M600:
            weight=self.Official_GluGlu_LFV_HToMuTau_M600_weight*self.event_weight(row,region,pileup) 
        elif self.isOfficial_GluGlu_LFV_HToMuTau_M750:
            weight=self.Official_GluGlu_LFV_HToMuTau_M750_weight*self.event_weight(row,region,pileup) 
        elif self.isOfficial_GluGlu_LFV_HToMuTau_M900:
            weight=self.Official_GluGlu_LFV_HToMuTau_M900_weight*self.event_weight(row,region,pileup) 

        elif self.isVBF_LFV_HToMuTau_M120:
            weight=self.VBF_LFV_HToMuTau_M120_weight*self.event_weight(row,region,pileup) 
        elif self.isVBF_LFV_HToMuTau_M125:
            weight=self.VBF_LFV_HToMuTau_M125_weight*self.event_weight(row,region,pileup) 
        elif self.isVBF_LFV_HToMuTau_M130:
            weight=self.VBF_LFV_HToMuTau_M130_weight*self.event_weight(row,region,pileup) 
        elif self.isVBF_LFV_HToMuTau_M150:
            weight=self.VBF_LFV_HToMuTau_M150_weight*self.event_weight(row,region,pileup) 

        elif self.isVBFEtauSig:
            weight=self.VBF_LFV_HToETau_weight*self.event_weight(row,region,pileup) 
        elif self.isGluGluEtauSig:
            weight=self.GluGlu_LFV_HToETau_weight*self.event_weight(row,region,pileup) 
        else:
...
#            print "non-repeat"
            ...
            trigger=True
            #trigger
            if self.isGluGlu_LFV_HToMuTau_M300 or self.isGluGlu_LFV_HToMuTau_M450 or self.isGluGlu_LFV_HToMuTau_M600 or self.isGluGlu_LFV_HToMuTau_M750 or self.isGluGlu_LFV_HToMuTau_M900:trigger=False
...
#                    if category!=4:               
                ...
                if self.my_elec.Pt() < 30: continue
