...
class Analyzer_MuE_highmass_450optimized_Mu50_pt160(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(Analyzer_MuE_highmass_450optimized_Mu50_pt160, self).__init__(tree, outfile, **kwargs)
...
#                    if category!=4:               
                ...
                if self.my_muon.Pt() < 160: continue 
