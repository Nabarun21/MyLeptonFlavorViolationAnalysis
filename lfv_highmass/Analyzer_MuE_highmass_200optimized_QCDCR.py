...
class Analyzer_MuE_highmass_200optimized_QCDCR(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(Analyzer_MuE_highmass_200optimized_QCDCR, self).__init__(tree, outfile, **kwargs)
           ...
           #take care of ecal gap
            ...
            ## now divide by e-mu isolation regions, looseloose,loosetight,tightloose,tighttight
                ...
                if not isMuonTight and not isElecTight: #double fakes, should be tiny
                    ...
                    region="signal"#call fake,signal 
