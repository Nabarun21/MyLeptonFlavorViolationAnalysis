...
class Analyzer_MuE_highmass_optcuts900(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(Analyzer_MuE_highmass_optcuts900, self).__init__(tree, outfile, **kwargs)
...
#                    if category!=4:               
                ...
                if self.my_muon.Pt() < 300: continue 
