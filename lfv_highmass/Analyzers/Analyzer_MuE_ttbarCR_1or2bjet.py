...
class Analyzer_MuE_ttbarCR_1or2bjet(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(Analyzer_MuE_ttbarCR_1or2bjet, self).__init__(tree, outfile, **kwargs)
...
#            print "non-repeat"
            ...
            if nbtagged!=1 and nbtagged!=2:continue
            btagweight=1
            ...
            if not self.isData:
                  ...
                  btagweight2=bTagSF.bTagEventWeight(nbtagged,row.jb1pt,row.jb1hadronflavor,row.jb2pt,row.jb2hadronflavor,1,0,2) if (row.jb1pt>-990 and row.jb1hadronflavor>-990 and row.jb2pt>-990 and row.jb2hadronflavor>-990) else 0
