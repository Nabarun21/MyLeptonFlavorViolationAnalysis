...
parser.add_argument(
    ...
    action="store",
    dest="outputdir",
    default="preprocessed_inputs/inclusive",
...
#            print "found neg bin  ",j
   ...
   if not histo:
      continue
   try:
         os.makedirs(args.outputdir+"/"+args.analyzer_name+str(args.Lumi))
   except Exception as ex:
                         print ex

   outputfile=ROOT.TFile(args.outputdir+"/"+args.analyzer_name+str(args.Lumi)+"/"+var[0]+".root","recreate")
