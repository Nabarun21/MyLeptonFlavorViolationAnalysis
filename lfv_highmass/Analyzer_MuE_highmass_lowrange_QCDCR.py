...
class Analyzer_MuE_highmass_lowrange_QCDCR(MegaBase):
    tree = 'em/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        self.channel='EMu'
        super(Analyzer_MuE_highmass_lowrange_QCDCR, self).__init__(tree, outfile, **kwargs)
 ...
 #        self.DYlowmass_weight=1.99619334706e-08
        ...
        self.GluGluHToWW_weight=2.07849993893e-06 #1.91354271402e-06
        self.VBFHToWW_weight=4.44881906235e-08 #4.09574479328e-08

        self.GluGluHToTT_weight=1.02130780413e-06#2.05507004808e-06  #2.07059122633e-06 
        self.ZHToTauTau_weight=1.38632844681e-08#1.28035908968e-07  #1.28035908968e-07
        self.WplusHToTauTau_weight=2.262369698e-08 #2.33513589465e-07
        self.WminusHToTauTau_weight=3.61317718356e-08#3.59334302781e-07
        self.VBFHToTT_weight=2.11763073232e-08#4.23479177085e-08                                   #4.23479177085e-08 
        self.ttHToTT_weight=7.1143619819e-08#7.1143619819e-08                                   #4.23479177085e-08 
...
#        alldirs=['']
    ...
    def fill_histos(self, row,sign,f=None,fillCommonOnly=False,region=None,btagweight=1,sys='',qcdshape=None,pileup='nominal'):
        ...
        if self.is_WJet or self.is_DYJet or self.is_DYlowmass or self.is_ZTauTau:
            ...
            raise ValueError("Weights not found for current process :{}".format(self.target))
